...
//         when(
//           recipientMock.authenticate("some-password")(
...
//         when(
//           recipientMock.isVerified(recipientRepositoryMock, executionContext)
//         )
//           .thenReturn(Future.successful(true))
...
//       "log in in a new session if already logged in" in new LoginSetup {
//         pending
//       }
//     }
